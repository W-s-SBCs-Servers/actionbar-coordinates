...
# Display it
execute as @a run title @s actionbar ["", {"text": "x:", "color": "gold"}, {"score": {"name": "@s", "objective": "position_x"}, "color": "red"}, {"text": "y:", "color": "gold"}, {"score": {"name": "@s", "objective": "position_y"}, "color": "red"}, {"text": "z:", "color": "gold"}, {"score": {"name": "@s", "objective": "position_z"}, "color": "red"}]
